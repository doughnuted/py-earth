...
def get_ext_modules():
    ...
    import sysconfig
    python_cpy_inc = sysconfig.get_path('include') + '/cpython'
    ...
    if cythonize_switch:
        ...
        ext_modules = cythonize(
            [Extension(
                "pyearth._util", ["pyearth/_util.pyx"], include_dirs=[local_inc, python_cpy_inc, numpy_inc]),
             Extension(
                 "pyearth._basis",
                 ["pyearth/_basis.pyx"],
                 include_dirs=[local_inc, python_cpy_inc, numpy_inc]),
             Extension(
                 "pyearth._record",
                 ["pyearth/_record.pyx"],
                 include_dirs=[local_inc, python_cpy_inc, numpy_inc]),
        ...
        ext_modules = [Extension(
            "pyearth._util", ["pyearth/_util.c"], include_dirs=[local_inc, python_cpy_inc, numpy_inc]),
            Extension(
                "pyearth._basis",
                ["pyearth/_basis.c"],
                include_dirs=[local_inc, python_cpy_inc, numpy_inc]),
