...
def setup_package():
    ...
    setup_args = {
        ...
        'extras_require': {'docs': ['sphinx_gallery'],
                           'dev': ['cython'],
                           'export': ['sympy'],
                           'all_tests': ['pandas', 'statsmodels', 'patsy', 'sympy', 'pytest', 'pytest-cov']},
        'setup_requires': ['numpy'],
        'include_package_data': True
    }

    # Always use setuptools' build_ext, which should handle Cython modules
    # when ext_modules are generated by cythonize(), or pre-compiled .c files.
    # versioneer.get_cmdclass() will be merged with any default cmdclass.
